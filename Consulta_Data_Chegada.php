...
//fim da recolha do front in
                ...
                try {
                    ...
                    $stmt = $conn->prepare("SELECT Data, Nome, Apelido, Hora, Voo, Proveniencia,  Destino, Descricao, Terceiro, Motorista FROM meetchegadas WHERE  Data>= '$Chegadas'ORDER BY Data, Hora, Terceiro ASC");
