...
//fim da recolha do front in
                ...
                try {
                    ...
                    $stmt = $conn->prepare("SELECT Data, Nome, Apelido, Hora, Voo, Proveniencia,  Destino, Descricao, Terceiro, Motorista FROM meetpartida WHERE  Data>= '$Partidas'ORDER BY Data, Hora, Terceiro ASC");
